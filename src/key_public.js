...
/**
  ...
  @param {string} [pubkey_prefix = 'QQBC']
*/
function PublicKey(Q, pubkey_prefix = 'QQBC') {
    if(typeof Q === 'string') {
     ...
     * @arg {string} [pubkey_prefix = 'QQBC'] - public key prefix
    */
    function toString(pubkey_prefix = 'QQBC') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'QQBC']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'QQBC') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'QQBC') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'QQBC') {
