...
ecc.randomKey().then(privateKey => {
  ...
  console.log('Public Key:\t', ecc.privateToPublic(privateKey)) // QQBCkey...
})
    */
    ...
    */
    privateToPublic: (wif, pubkey_prefix = 'QQBC') =>
      PrivateKey(wif).toPublic().toString(pubkey_prefix),

    /**
        @arg {pubkey} pubkey - like QQBCKey..
        @arg {string} [pubkey_prefix = 'QQBC']

        @return {boolean} valid

        @example ecc.isValidPublic(pubkey) === true
    */
    isValidPublic: (pubkey, pubkey_prefix = 'QQBC') =>
    ...
    */
    ...
    /**
        ...
        @arg {String|Buffer} signature (QQBCbase58sig.., Hex, Buffer)
