...
describe('Common API', () => {
  ...
  it('privateToPublic', () => {
    ...
    const pub = 'QQBC859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'
  ...
  it('isValidPublic', () => {
    const keys = [
      ...
      [true, 'QQBC859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'],
      [false, 'MMM859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'],
      [false, 'QQBC859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVm', 'QQBC'],
