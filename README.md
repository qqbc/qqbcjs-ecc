[![NPM](https://img.shields.io/npm/v/qqbcjs-ecc.svg)](https://www.npmjs.org/package/qqbcjs-ecc)
[![Build Status](https://travis-ci.org/QQBCIO/qqbcjs-ecc.svg?branch=master)](https://travis-ci.org/QQBCIO/qqbcjs-ecc)
...
```js
import ecc from 'qqbcjs-ecc'
// or
const ecc = require('qqbcjs-ecc')
```

# Include

-   Install with: `yarn add qqbcjs-ecc`
-   Html script tag, see [releases](https://github.com/QQBCIO/qqbcjs-ecc/releases) for the correct **version** and its matching script **integrity** hash.
...
<head>
  <meta charset="utf-8">
  <!--
  sha512-cL+IQQaQ586s9DrXfGtDheRpj5iDKh2M+xlpfwbhNjRIp4BGQ1fkM/vB4Ta8mc+f51YBW9sJiPcyMDIreJe6gQ== lib/qqbcjs-ecc.js
  sha512-dYFDmK/d9r3/NCp6toLtfkwOjSMRBaEzaGAx1tfRItC0nsI0hVLERk05iNBQR7uDNI7ludYhcBI4vUiFHdjsTQ== lib/qqbcjs-ecc.min.js
  sha512-eq1SCoSe38uR1UVuQMwR73VgY8qKTBDc87n2nIiC5WLhn1o2y1U6c5wY8lrigVX7INM8fM0PxDlMX5WvpghKig== lib/qqbcjs-ecc.min.js.map
  -->
  <script src="https://cdn.jsdelivr.net/npm/qqbcjs-ecc@4.0.4/lib/qqbcjs-ecc.min.js"
    integrity="sha512-dYFDmK/d9r3/NCp6toLtfkwOjSMRBaEzaGAx1tfRItC0nsI0hVLERk05iNBQR7uDNI7ludYhcBI4vUiFHdjsTQ=="
    crossorigin="anonymous"></script>

</head>
<body>
  See console object: qqbcjs_ecc
</body>
</html>
```
...
-   `wif` **[wif](#wif)** 
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** public key prefix (optional, default `'QQBC'`)
...
-   `pubkey` **[pubkey](#pubkey)** like QQBCKey..
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)**  (optional, default `'QQBC'`)
...
-   `signature` **([String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String) \| [Buffer](https://nodejs.org/api/buffer.html))** (QQBCbase58sig.., Hex, Buffer)
...
```js
let {PrivateKey, PublicKey, Signature, Aes, key_utils, config} = require('qqbcjs-ecc')
...
```bash
git clone https://github.com/QQBCIO/qqbcjs-ecc.git
cd qqbcjs-ecc
yarn
yarn build_browser
# builds: ./dist/qqbcjs-ecc.js
# Verify release hash
```

```html
<script src=qqbcjs-ecc.js></script>
```
